...
/**如果你定义了“__cplusplus”这个宏，说明你的意图是想在C++文件中调用这个头文件，我前头说了，C语言
	的头文件C++是不认识的，怎么办呢，就加上extern "C" {。。。。。｝告诉C++文件，大括号里面的东西是
	用C语言写的，然后C++文件就认识了，就能调用这个头文件里的东西了，extern "C" { }的存在，使得C语
	言和C++能更好的结合的一块。 	2014.1.3
	*/
#ifdef __cplusplus
 extern "C" {
#endif 
 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
   */
//#define HSE_STARTUP_TIMEOUT   ((uint16_t)0x0500) /*!< Time out for HSE start up */		//STM32 ZCL  2021.5.4
#define HSE_STARTUP_TIMEOUT   ((uint16_t)0xFFFF) /*!< Time out for HSE start up */		//GD32 ZCL 2021.5.4  加大启动时间
