...
void Menu_LoRaSetPar6(void) // 画面 LoRa设定参数
{
	if (Lw_SavePageNo != Lw_PageNo)
	{
		...
		LCD12864_String(0x8F, "  ");
		// 第四行
		LCD12864_String(0x98, "(0供水，1=变频) ");
		// LCD12864_String(0x9F, "  ");
	}

	ModParNum(3);
	// 显示和修改参数
	DispMod_Par(0x84, 0x05, 0x00, &Pw_ConsoleInfo, 4, F_ModPar1);
	DispMod_Par(0x94, 0x05, 0x00, &Pw_RebootInterval, 4, F_ModPar2);
	DispMod_Par(0x8C, 0x05, 0x00, &Pw_EquipmentType, 5, F_ModPar3); // 类型4和5，在DispMod_Par()中没有用 ZCL 2018.8.3
