...
void Menu_LoRaSetPar6(void) // 画面 LoRa设定参数
{
	...
	ModParNum(2);
	// 显示和修改参数
	DispMod_Par(0x85, 0x05, 0x00, &Pw_ConsoleInfo, 4, F_ModPar1);
	DispMod_Par(0x95, 0x05, 0x00, &Pw_RebootInterval, 4, F_ModPar2);
...
void Menu_LoRaSetPar7(void) // 画面 LoRa设定参数
{
	...
	ModParNum(0);
	// 显示和修改参数
	DispMod_Par(0x84, 0x04, 0x02, &w_ScrVERSION, 5, 0);
