...
#define SCR_WRPAR_ADDRESS 40000	 // 读写参数地址；w_GprsParLst，访问时偏移40000访问w_ScrParLst
// ZCL 2023.2.9
#define STM32_WRPAR_ADDRESS_SQB 50000 // 读写参数地址；Pw_ParLst，访问时偏移50000访问
#define STM32_WRPAR_ADDRESS_BPDJ 0	  // 读写参数地址；Pw_ParLst，访问时偏移00000访问
...
#define w_HighV1DispWenDu1DecValue w_ParLst[300 + 8 * 24 + 2] //.1 温度值1- U 相温度
#define w_HighV1DispWenDu2DecValue w_ParLst[300 + 8 * 24 + 3] //.1 温度值2- V 相温度
#define w_HighV1DispWenDu3DecValue w_ParLst[300 + 8 * 24 + 4] //.1 温度值3- W 相温度
#define w_HighV1DispWenDu4DecValue w_ParLst[300 + 8 * 24 + 5] //.1 温度值4- 电机轴伸端温度
#define w_HighV1DispWenDu5DecValue w_ParLst[300 + 8 * 24 + 6] //.1 温度值5- 电机非轴伸端温度
#define w_HighV1DispWenDu6DecValue w_ParLst[300 + 8 * 24 + 7] //.1 温度值6-环境温度

#define w_HighV1DispDianLi1 w_ParLst[300 + 8 * 24 + 8]	 //.x 电力参数1-线电压 UV
#define w_HighV1DispDianLi2 w_ParLst[300 + 8 * 24 + 9]	 //.x 电力参数1-线电压 VW
#define w_HighV1DispDianLi3 w_ParLst[300 + 8 * 24 + 10]	 //.x 电力参数1-线电压 UW
#define w_HighV1DispDianLi4 w_ParLst[300 + 8 * 24 + 11]	 //.x 电力参数1-相电流 I1
#define w_HighV1DispDianLi5 w_ParLst[300 + 8 * 24 + 12]	 //.x 电力参数1-相电流 I2
#define w_HighV1DispDianLi6 w_ParLst[300 + 8 * 24 + 13]	 //.x 电力参数1-相电流 I3
#define w_HighV1DispDianLi7 w_ParLst[300 + 8 * 24 + 14]	 //.x 电力参数1-总有功功率
#define w_HighV1DispDianLi8 w_ParLst[300 + 8 * 24 + 15]	 //.x 电力参数1-频率
...
// 电机2
#define w_HighV2DispSoftVersion w_ParLst[300 + 9 * 24 + 0]	  // 版本
...
// 电机3
#define w_HighV3DispSoftVersion w_ParLst[300 + 10 * 24 + 0]	   // 版本
...
// 电机4
#define w_HighV4DispSoftVersion w_ParLst[300 + 11 * 24 + 0]	   // 版本
...
// 电机5
#define w_HighV5DispSoftVersion w_ParLst[300 + 12 * 24 + 0]	   // 版本
...
// 电机6
#define w_HighV6DispSoftVersion w_ParLst[300 + 13 * 24 + 0]	   // 版本
...
// 电机7
#define w_HighV7DispSoftVersion w_ParLst[300 + 14 * 24 + 0]	   // 版本
...
// 电机8
#define w_HighV8DispSoftVersion w_ParLst[300 + 15 * 24 + 0]	   // 版本
...
// volatile uint	xdata	w_GprsParLst[280];					// 参数字列表区
...
#define Pw_EquipmentType w_GprsParLst[8] //.0 设备类型，=0，双驱泵；=1，变频电机；=2，高压电机
...
#define Pw_CheckUpgrade w_GprsParLst[30]	  //.0 检查升级
...
#define w_S_M35 w_GprsParLst[69]			  //.0 YLS 2025.2.24 GPRS模块当前状态
