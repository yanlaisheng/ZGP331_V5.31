...
u16 Count_Save1_No1_VVVF_Comm; // 判断1#泵变频器通讯故障计时
u16 Count_Save2_No1_VVVF_Comm; // 判断1#泵变频器通讯故障计数
u16 Count_Save1_No2_VVVF_Comm; // 判断2#泵变频器通讯故障计时
u16 Count_Save2_No2_VVVF_Comm; // 判断2#泵变频器通讯故障计数
u16 Count_Save1_No3_VVVF_Comm; // 判断3#泵变频器通讯故障计时
u16 Count_Save2_No3_VVVF_Comm; // 判断3#泵变频器通讯故障计数
u16 Count_Save1_No4_VVVF_Comm; // 判断4#泵变频器通讯故障计时
u16 Count_Save2_No4_VVVF_Comm; // 判断4#泵变频器通讯故障计数
u16 Count_Save1_No5_VVVF_Comm; // 判断5#泵变频器通讯故障计时
u16 Count_Save2_No5_VVVF_Comm; // 判断5#泵变频器通讯故障计数
u16 Count_Save1_No6_VVVF_Comm; // 判断6#泵变频器通讯故障计时
u16 Count_Save2_No6_VVVF_Comm; // 判断6#泵变频器通讯故障计数
u16 Count_Save1_No7_VVVF_Comm; // 判断7#泵变频器通讯故障计时
u16 Count_Save2_No7_VVVF_Comm; // 判断7#泵变频器通讯故障计数
u16 Count_Save1_No8_VVVF_Comm; // 判断8#泵变频器通讯故障计时
u16 Count_Save2_No8_VVVF_Comm; // 判断8#泵变频器通讯故障计数
#endif                         /* __GLOBALV_H */
