...
u16 w_ParLst[500];  // 参数字列表区 只读		//1区访问
...
u16 w_GprsParLst[180]; // 参数字列表区 读写 ZCL 2018.12.10		//4区访问，这个本身参数，实际不用4访问
...
u16 T_Judge_No1_Comm_LoRa; // 判断1#泵LoRa通讯故障计时
u16 C_Judge_No1_Comm_LoRa; // 判断1#泵LoRa通讯故障计数
u16 T_Judge_No2_Comm_LoRa; // 判断2#泵LoRa通讯故障计时
u16 C_Judge_No2_Comm_LoRa; // 判断2#泵LoRa通讯故障计数
u16 T_Judge_No3_Comm_LoRa; // 判断3#泵LoRa通讯故障计时
u16 C_Judge_No3_Comm_LoRa; // 判断3#泵LoRa通讯故障计数
u16 T_Judge_No4_Comm_LoRa; // 判断4#泵LoRa通讯故障计时
u16 C_Judge_No4_Comm_LoRa; // 判断4#泵LoRa通讯故障计数
u16 T_Judge_No5_Comm_LoRa; // 判断5#泵LoRa通讯故障计时
u16 C_Judge_No5_Comm_LoRa; // 判断5#泵LoRa通讯故障计数
u16 T_Judge_No6_Comm_LoRa; // 判断6#泵LoRa通讯故障计时
u16 C_Judge_No6_Comm_LoRa; // 判断6#泵LoRa通讯故障计数
u16 T_Judge_No7_Comm_LoRa; // 判断7#泵LoRa通讯故障计时
u16 C_Judge_No7_Comm_LoRa; // 判断7#泵LoRa通讯故障计数
u16 T_Judge_No8_Comm_LoRa; // 判断8#泵LoRa通讯故障计时
u16 C_Judge_No8_Comm_LoRa; // 判断8#泵LoRa通讯故障计数

u8 F_No1_Send_LoRa; // 1#泵LoRa发送标志
u8 F_No2_Send_LoRa; // 2#泵LoRa发送标志
u8 F_No3_Send_LoRa; // 3#泵LoRa发送标志
u8 F_No4_Send_LoRa; // 4#泵LoRa发送标志
u8 F_No5_Send_LoRa; // 5#泵LoRa发送标志
u8 F_No6_Send_LoRa; // 6#泵LoRa发送标志
u8 F_No7_Send_LoRa; // 7#泵LoRa发送标志
u8 F_No8_Send_LoRa; // 8#泵LoRa发送标志

u8 F_No1_LoRa_Fault; // 1#泵LoRa通讯异常标志
u8 F_No2_LoRa_Fault; // 2#泵LoRa通讯异常标志
u8 F_No3_LoRa_Fault; // 3#泵LoRa通讯异常标志
u8 F_No4_LoRa_Fault; // 4#泵LoRa通讯异常标志
u8 F_No5_LoRa_Fault; // 5#泵LoRa通讯异常标志
u8 F_No6_LoRa_Fault; // 6#泵LoRa通讯异常标志
u8 F_No7_LoRa_Fault; // 7#泵LoRa通讯异常标志
u8 F_No8_LoRa_Fault; // 8#泵LoRa通讯异常标志

u8 F_No1_VVVFComm_Fault; // 1#泵变频器通讯异常标志
u8 F_No2_VVVFComm_Fault; // 2#泵LoRa通讯异常标志
u8 F_No3_VVVFComm_Fault; // 3#泵LoRa通讯异常标志
u8 F_No4_VVVFComm_Fault; // 4#泵LoRa通讯异常标志
u8 F_No5_VVVFComm_Fault; // 5#泵LoRa通讯异常标志
u8 F_No6_VVVFComm_Fault; // 6#泵LoRa通讯异常标志
u8 F_No7_VVVFComm_Fault; // 7#泵LoRa通讯异常标志
u8 F_No8_VVVFComm_Fault; // 8#泵LoRa通讯异常标志
#endif                   /* __GLOBALV_H */
