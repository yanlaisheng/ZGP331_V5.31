...
void Menu_LoRaSetPar6(void) // 画面 LoRa设定参数
{
	if (Pw_EquipmentType == 0 || Pw_EquipmentType == 2) // 双驱泵或高压电机
	{
		if (Lw_SavePageNo != Lw_PageNo)
		{
			...
			LCD12864_String(0x98, "0双驱1变频2高压");
			// LCD12864_String(0x9F, "  ");
		}
...
void Menu_Dsp1ReadPar2(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		DispMod_Par(0x84, 0x04, 0x01, &w_HighV1DispDianLi8, 5, 0);
		DispMod_Par(0x94, 0x05, 0x00, &w_HighV1DispDianLi1, 5, 0);
		DispMod_Par(0x8C, 0x05, 0x00, &w_HighV1DispDianLi2, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV1DispDianLi3, 5, 0);
...
void Menu_Dsp1ReadPar3(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		DispMod_Par(0x84, 0x04, 0x01, &w_HighV1DispDianLi4, 5, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV1DispDianLi5, 5, 0);
		DispMod_Par(0x8C, 0x04, 0x01, &w_HighV1DispDianLi6, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV1DispDianLi7, 5, 0);
...
void Menu_Dsp1ReadPar4(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		if (w_HighV1DispWenDu1DecValue >= 10000)
		{
			w_HighV1DispWenDu1DecValue = w_HighV1DispWenDu1DecValue - 10000;
			i1 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV1DispWenDu2DecValue >= 10000)
		{
			w_HighV1DispWenDu2DecValue = w_HighV1DispWenDu2DecValue - 10000;
			i2 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV1DispWenDu3DecValue >= 10000)
		{
			w_HighV1DispWenDu3DecValue = w_HighV1DispWenDu3DecValue - 10000;
			i3 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV1DispWenDu4DecValue >= 10000)
		{
			w_HighV1DispWenDu4DecValue = w_HighV1DispWenDu4DecValue - 10000;
			i4 = 10; // ZCL 2019.10.18 加上负号
		}

		DispMod_Par(0x84, 0x04, 0x01, &w_HighV1DispWenDu1DecValue, 5 + i1, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV1DispWenDu2DecValue, 5 + i2, 0);
		DispMod_Par(0x8C, 0x04, 0x01, &w_HighV1DispWenDu3DecValue, 5 + i3, 0);
		DispMod_Par(0x9C, 0x04, 0x01, &w_HighV1DispWenDu4DecValue, 5 + i4, 0);
...
void Menu_Dsp1ReadPar5(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		if (w_HighV1DispWenDu5DecValue >= 10000)
		{
			w_HighV1DispWenDu5DecValue = w_HighV1DispWenDu5DecValue - 10000;
			i5 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV1DispWenDu6DecValue >= 10000)
		{
			w_HighV1DispWenDu6DecValue = w_HighV1DispWenDu6DecValue - 10000;
			i6 = 10; // ZCL 2019.10.18 加上负号
		}

		DispMod_Par(0x84, 0x04, 0x01, &w_HighV1DispWenDu5DecValue, 5 + i5, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV1DispWenDu6DecValue, 5 + i6, 0);

		DispMod_Par(0x8C, 0x04, 0x02, &w_HighV1SoftVersion, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV1Counter, 5, 0); // ZCL 2018.5.19
...
void Menu_Dsp2ReadPar2(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		DispMod_Par(0x84, 0x04, 0x01, &w_HighV2DispDianLi8, 5, 0);
		DispMod_Par(0x94, 0x05, 0x00, &w_HighV2DispDianLi1, 5, 0);
		DispMod_Par(0x8C, 0x05, 0x00, &w_HighV2DispDianLi2, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV2DispDianLi3, 5, 0);
...
void Menu_Dsp2ReadPar3(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		DispMod_Par(0x84, 0x04, 0x01, &w_HighV2DispDianLi4, 5, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV2DispDianLi5, 5, 0);
		DispMod_Par(0x8C, 0x04, 0x01, &w_HighV2DispDianLi6, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV2DispDianLi7, 5, 0);
...
void Menu_Dsp2ReadPar4(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		if (w_HighV2DispWenDu1DecValue >= 10000)
		{
			w_HighV2DispWenDu1DecValue = w_HighV2DispWenDu1DecValue - 10000;
			i1 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV2DispWenDu2DecValue >= 10000)
		{
			w_HighV2DispWenDu2DecValue = w_HighV2DispWenDu2DecValue - 10000;
			i2 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV2DispWenDu3DecValue >= 10000)
		{
			w_HighV2DispWenDu3DecValue = w_HighV2DispWenDu3DecValue - 10000;
			i3 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV2DispWenDu4DecValue >= 10000)
		{
			w_HighV2DispWenDu4DecValue = w_HighV2DispWenDu4DecValue - 10000;
			i4 = 10; // ZCL 2019.10.18 加上负号
		}

		DispMod_Par(0x84, 0x04, 0x01, &w_HighV2DispWenDu1DecValue, 5 + i1, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV2DispWenDu2DecValue, 5 + i2, 0);
		DispMod_Par(0x8C, 0x04, 0x01, &w_HighV2DispWenDu3DecValue, 5 + i3, 0);
		DispMod_Par(0x9C, 0x04, 0x01, &w_HighV2DispWenDu4DecValue, 5 + i4, 0);
...
void Menu_Dsp2ReadPar5(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		if (w_HighV2DispWenDu5DecValue >= 10000)
		{
			w_HighV2DispWenDu5DecValue = w_HighV2DispWenDu5DecValue - 10000;
			i5 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV2DispWenDu6DecValue >= 10000)
		{
			w_HighV2DispWenDu6DecValue = w_HighV2DispWenDu6DecValue - 10000;
			i6 = 10; // ZCL 2019.10.18 加上负号
		}

		DispMod_Par(0x84, 0x04, 0x01, &w_HighV2DispWenDu5DecValue, 5 + i5, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV2DispWenDu6DecValue, 5 + i6, 0);

		DispMod_Par(0x8C, 0x04, 0x02, &w_HighV2SoftVersion, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV2Counter, 5, 0); // ZCL 2018.5.19
...
void Menu_Dsp3ReadPar2(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		DispMod_Par(0x84, 0x04, 0x01, &w_HighV3DispDianLi8, 5, 0);
		DispMod_Par(0x94, 0x05, 0x00, &w_HighV3DispDianLi1, 5, 0);
		DispMod_Par(0x8C, 0x05, 0x00, &w_HighV3DispDianLi2, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV3DispDianLi3, 5, 0);
...
void Menu_Dsp3ReadPar3(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		DispMod_Par(0x84, 0x04, 0x01, &w_HighV3DispDianLi4, 5, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV3DispDianLi5, 5, 0);
		DispMod_Par(0x8C, 0x04, 0x01, &w_HighV3DispDianLi6, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV3DispDianLi7, 5, 0);
...
void Menu_Dsp3ReadPar4(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		if (w_HighV3DispWenDu1DecValue >= 10000)
		{
			w_HighV3DispWenDu1DecValue = w_HighV3DispWenDu1DecValue - 10000;
			i1 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV3DispWenDu2DecValue >= 10000)
		{
			w_HighV3DispWenDu2DecValue = w_HighV3DispWenDu2DecValue - 10000;
			i2 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV3DispWenDu3DecValue >= 10000)
		{
			w_HighV3DispWenDu3DecValue = w_HighV3DispWenDu3DecValue - 10000;
			i3 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV3DispWenDu4DecValue >= 10000)
		{
			w_HighV3DispWenDu4DecValue = w_HighV3DispWenDu4DecValue - 10000;
			i4 = 10; // ZCL 2019.10.18 加上负号
		}

		DispMod_Par(0x84, 0x04, 0x01, &w_HighV3DispWenDu1DecValue, 5 + i1, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV3DispWenDu2DecValue, 5 + i2, 0);
		DispMod_Par(0x8C, 0x04, 0x01, &w_HighV3DispWenDu3DecValue, 5 + i3, 0);
		DispMod_Par(0x9C, 0x04, 0x01, &w_HighV3DispWenDu4DecValue, 5 + i4, 0);
...
void Menu_Dsp3ReadPar5(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		if (w_HighV3DispWenDu5DecValue >= 10000)
		{
			w_HighV3DispWenDu5DecValue = w_HighV3DispWenDu5DecValue - 10000;
			i5 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV3DispWenDu6DecValue >= 10000)
		{
			w_HighV3DispWenDu6DecValue = w_HighV3DispWenDu6DecValue - 10000;
			i6 = 10; // ZCL 2019.10.18 加上负号
		}

		DispMod_Par(0x84, 0x04, 0x01, &w_HighV3DispWenDu5DecValue, 5 + i5, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV3DispWenDu6DecValue, 5 + i6, 0);

		DispMod_Par(0x8C, 0x04, 0x02, &w_HighV3SoftVersion, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV3Counter, 5, 0); // ZCL 2018.5.19
...
void Menu_Dsp4ReadPar2(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		DispMod_Par(0x84, 0x04, 0x01, &w_HighV4DispDianLi8, 5, 0);
		DispMod_Par(0x94, 0x05, 0x00, &w_HighV4DispDianLi1, 5, 0);
		DispMod_Par(0x8C, 0x05, 0x00, &w_HighV4DispDianLi2, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV4DispDianLi3, 5, 0);
...
void Menu_Dsp4ReadPar3(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		DispMod_Par(0x84, 0x04, 0x01, &w_HighV4DispDianLi4, 5, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV4DispDianLi5, 5, 0);
		DispMod_Par(0x8C, 0x04, 0x01, &w_HighV4DispDianLi6, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV4DispDianLi7, 5, 0);
...
void Menu_Dsp4ReadPar4(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		if (w_HighV4DispWenDu1DecValue >= 10000)
		{
			w_HighV4DispWenDu1DecValue = w_HighV4DispWenDu1DecValue - 10000;
			i1 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV4DispWenDu2DecValue >= 10000)
		{
			w_HighV4DispWenDu2DecValue = w_HighV4DispWenDu2DecValue - 10000;
			i2 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV4DispWenDu3DecValue >= 10000)
		{
			w_HighV4DispWenDu3DecValue = w_HighV4DispWenDu3DecValue - 10000;
			i3 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV4DispWenDu4DecValue >= 10000)
		{
			w_HighV4DispWenDu4DecValue = w_HighV4DispWenDu4DecValue - 10000;
			i4 = 10; // ZCL 2019.10.18 加上负号
		}

		DispMod_Par(0x84, 0x04, 0x01, &w_HighV4DispWenDu1DecValue, 5 + i1, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV4DispWenDu2DecValue, 5 + i2, 0);
		DispMod_Par(0x8C, 0x04, 0x01, &w_HighV4DispWenDu3DecValue, 5 + i3, 0);
		DispMod_Par(0x9C, 0x04, 0x01, &w_HighV4DispWenDu4DecValue, 5 + i4, 0);
...
void Menu_Dsp4ReadPar5(void) // 画面 DSP读参数
{
	...
	else if (Pw_EquipmentType == 2) // 高压电机
	{
		...
		if (w_HighV4DispWenDu5DecValue >= 10000)
		{
			w_HighV4DispWenDu5DecValue = w_HighV4DispWenDu5DecValue - 10000;
			i5 = 10; // ZCL 2019.10.18 加上负号
		}
		if (w_HighV4DispWenDu6DecValue >= 10000)
		{
			w_HighV4DispWenDu6DecValue = w_HighV4DispWenDu6DecValue - 10000;
			i6 = 10; // ZCL 2019.10.18 加上负号
		}

		DispMod_Par(0x84, 0x04, 0x01, &w_HighV4DispWenDu5DecValue, 5 + i5, 0);
		DispMod_Par(0x94, 0x04, 0x01, &w_HighV4DispWenDu6DecValue, 5 + i6, 0);

		DispMod_Par(0x8C, 0x04, 0x02, &w_HighV4SoftVersion, 5, 0);
		DispMod_Par(0x9C, 0x05, 0x00, &w_HighV4Counter, 5, 0); // ZCL 2018.5.19
...
void GetKey(void) // ZCL 得到按键的键值 2013.12.07
{
	...
	if (Pw_EquipmentType == 0 || Pw_EquipmentType == 2) // 双驱泵或高压电机
	{
		...
		else if (Pw_LoRaMasterSlaveSel == 1) // LORA主机
		{
			...
			else if (Lw_PageNo == 526 && B_LeftKeyCount == 2) // 高压电机
			{
				Lw_PageNo = 531;
				B_LeftKeyCount = 0;
				B_RightKeyCount = 0;
			}
			else if (Lw_PageNo == 531 && B_LeftKeyCount == 2) // 高压电机
			{
				Lw_PageNo = 536;
				B_LeftKeyCount = 0;
				B_RightKeyCount = 0;
			...
			else if (Lw_PageNo == 536 && B_LeftKeyCount == 2) // 高压电机
			{
				Lw_PageNo = 543;
				B_LeftKeyCount = 0;
				B_RightKeyCount = 0;
