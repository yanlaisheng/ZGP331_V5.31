...
{
	if (Pw_LoRaModule1Add > 0 && !B_LoRaErrWithModule1) // 从机地址>0，并且没有LoRa通讯故障
	{
		if (T_Judge_No1_VVVF_Comm != SClk10Ms)
		{
			T_Judge_No1_VVVF_Comm = SClk10Ms; //
			C_Judge_No1_VVVF_Comm++;
			if (C_Judge_No1_VVVF_Comm > 1000) // 10s
			{
				T_Judge_No1_VVVF_Comm = 100;
				C_Judge_No1_VVVF_Comm = 0;
				B_LoRaErrWithModule1 = 1;	//
				F_LoRa1_VVVFComm_Fault = 1; // YLS 2025.01.27 置通讯故障标志
	...
	{
		B_LoRaErrWithModule1 = 0;	//
		F_LoRa1_VVVFComm_Fault = 0; // YLS 2025.01.27 清通讯故障标志
