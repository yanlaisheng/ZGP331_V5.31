...
uc8 DtuProgVersion[7] = "5.29";		 // 7 DTU程序版本:70		修改完程序后，要改这2个地方 YLS 2023.12.06
uc8 DtuProgMakeDate[8] = "20250204"; // 8 DTU程序生成日期:71		修改完程序后，要改这2个地方 YLS 2023.12.06
	...
	{										 // 接收处理过程
		...
		if (C_NoRcv3 > NORCVMAXMS) // && Cw_Rcv3!=1 && Rcv3Buffer[0]!=0)
		{
			...
			{							//;开始处理串口信息
				...
				else if (GprsPar[ConsoleInfoTypeBase] || Pw_ConsoleInfo) // 控制台信息类型,=1输出调试信息
				{
					if (Cw_BakRcv3 >= 512)
