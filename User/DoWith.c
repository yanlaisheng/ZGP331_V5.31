...
void DoWith(void) // 一些数据,记录的处理
{
	...
	if (Pw_EquipmentType == 0) // 双驱泵
	{
		...
		// 电机5 温度值变换
		nw_Wendu = (s16)(w_Lora5WenDu1);
		if (nw_Wendu < 0)
		{
			w_Pump5DispWenDu1DecValue = -nw_Wendu;
			w_Pump5DispWenDu1DecValue = w_Pump5DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_Pump5DispWenDu1DecValue = w_Lora5WenDu1;

		nw_Wendu = (s16)(w_Lora5WenDu2);
		if (nw_Wendu < 0)
		{
			w_Pump5DispWenDu2DecValue = -nw_Wendu;
			w_Pump5DispWenDu2DecValue = w_Pump5DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_Pump5DispWenDu2DecValue = w_Lora5WenDu2;
	}
	...
	else if (Pw_EquipmentType == 1 || Pw_EquipmentType == 2) // 变频电机或高压电机
	{
		...
		// ZCL 2022.10.5
		// 电机1 温度值变换
		nw_Wendu = (s16)(w_HighV1WenDu1DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV1DispWenDu1DecValue = -nw_Wendu;
			w_HighV1DispWenDu1DecValue = w_HighV1DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_HighV1DispWenDu1DecValue = w_HighV1WenDu1DecValue;

		nw_Wendu = (s16)(w_HighV1WenDu2DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV1DispWenDu2DecValue = -nw_Wendu;
			w_HighV1DispWenDu2DecValue = w_HighV1DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_HighV1DispWenDu2DecValue = w_HighV1WenDu2DecValue;

		nw_Wendu = (s16)(w_HighV1WenDu3DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV1DispWenDu3DecValue = -nw_Wendu;
			w_HighV1DispWenDu3DecValue = w_HighV1DispWenDu3DecValue + 10000; // 10000是负号
		}
		else
			w_HighV1DispWenDu3DecValue = w_HighV1WenDu3DecValue;

		nw_Wendu = (s16)(w_HighV1WenDu4DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV1DispWenDu4DecValue = -nw_Wendu;
			w_HighV1DispWenDu4DecValue = w_HighV1DispWenDu4DecValue + 10000; // 10000是负号
		}
		else
			w_HighV1DispWenDu4DecValue = w_HighV1WenDu4DecValue;

		nw_Wendu = (s16)(w_HighV1WenDu5DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV1DispWenDu5DecValue = -nw_Wendu;
			w_HighV1DispWenDu5DecValue = w_HighV1DispWenDu5DecValue + 10000; // 10000是负号
		}
		else
			w_HighV1DispWenDu5DecValue = w_HighV1WenDu5DecValue;

		nw_Wendu = (s16)(w_HighV1WenDu6DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV1DispWenDu6DecValue = -nw_Wendu;
			w_HighV1DispWenDu6DecValue = w_HighV1DispWenDu6DecValue + 10000; // 10000是负号
		}
		else
			w_HighV1DispWenDu6DecValue = w_HighV1WenDu6DecValue;
		// 以上温度值变换

		// 电机2 温度值变换
		nw_Wendu = (s16)(w_HighV2WenDu1DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV2DispWenDu1DecValue = -nw_Wendu;
			w_HighV2DispWenDu1DecValue = w_HighV2DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_HighV2DispWenDu1DecValue = w_HighV2WenDu1DecValue;

		nw_Wendu = (s16)(w_HighV2WenDu2DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV2DispWenDu2DecValue = -nw_Wendu;
			w_HighV2DispWenDu2DecValue = w_HighV2DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_HighV2DispWenDu2DecValue = w_HighV2WenDu2DecValue;

		nw_Wendu = (s16)(w_HighV2WenDu3DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV2DispWenDu3DecValue = -nw_Wendu;
			w_HighV2DispWenDu3DecValue = w_HighV2DispWenDu3DecValue + 10000; // 10000是负号
		}
		else
			w_HighV2DispWenDu3DecValue = w_HighV2WenDu3DecValue;

		nw_Wendu = (s16)(w_HighV2WenDu4DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV2DispWenDu4DecValue = -nw_Wendu;
			w_HighV2DispWenDu4DecValue = w_HighV2DispWenDu4DecValue + 10000; // 10000是负号
		}
		else
			w_HighV2DispWenDu4DecValue = w_HighV2WenDu4DecValue;

		nw_Wendu = (s16)(w_HighV2WenDu5DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV2DispWenDu5DecValue = -nw_Wendu;
			w_HighV2DispWenDu5DecValue = w_HighV2DispWenDu5DecValue + 10000; // 10000是负号
		}
		else
			w_HighV2DispWenDu5DecValue = w_HighV2WenDu5DecValue;

		nw_Wendu = (s16)(w_HighV2WenDu6DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV2DispWenDu6DecValue = -nw_Wendu;
			w_HighV2DispWenDu6DecValue = w_HighV2DispWenDu6DecValue + 10000; // 10000是负号
		}
		else
			w_HighV2DispWenDu6DecValue = w_HighV2WenDu6DecValue;
		// 以上温度值变换

		// 电机3 温度值变换
		nw_Wendu = (s16)(w_HighV3WenDu1DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV3DispWenDu1DecValue = -nw_Wendu;
			w_HighV3DispWenDu1DecValue = w_HighV3DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_HighV3DispWenDu1DecValue = w_HighV3WenDu1DecValue;

		nw_Wendu = (s16)(w_HighV3WenDu2DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV3DispWenDu2DecValue = -nw_Wendu;
			w_HighV3DispWenDu2DecValue = w_HighV3DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_HighV3DispWenDu2DecValue = w_HighV3WenDu2DecValue;

		nw_Wendu = (s16)(w_HighV3WenDu3DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV3DispWenDu3DecValue = -nw_Wendu;
			w_HighV3DispWenDu3DecValue = w_HighV3DispWenDu3DecValue + 10000; // 10000是负号
		}
		else
			w_HighV3DispWenDu3DecValue = w_HighV3WenDu3DecValue;

		nw_Wendu = (s16)(w_HighV3WenDu4DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV3DispWenDu4DecValue = -nw_Wendu;
			w_HighV3DispWenDu4DecValue = w_HighV3DispWenDu4DecValue + 10000; // 10000是负号
		}
		else
			w_HighV3DispWenDu4DecValue = w_HighV3WenDu4DecValue;

		nw_Wendu = (s16)(w_HighV3WenDu5DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV3DispWenDu5DecValue = -nw_Wendu;
			w_HighV3DispWenDu5DecValue = w_HighV3DispWenDu5DecValue + 10000; // 10000是负号
		}
		else
			w_HighV3DispWenDu5DecValue = w_HighV3WenDu5DecValue;

		nw_Wendu = (s16)(w_HighV3WenDu6DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV3DispWenDu6DecValue = -nw_Wendu;
			w_HighV3DispWenDu6DecValue = w_HighV3DispWenDu6DecValue + 10000; // 10000是负号
		}
		else
			w_HighV3DispWenDu6DecValue = w_HighV3WenDu6DecValue;
		// 以上温度值变换

		// 电机4 温度值变换
		nw_Wendu = (s16)(w_HighV4WenDu1DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV4DispWenDu1DecValue = -nw_Wendu;
			w_HighV4DispWenDu1DecValue = w_HighV4DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_HighV4DispWenDu1DecValue = w_HighV4WenDu1DecValue;

		nw_Wendu = (s16)(w_HighV4WenDu2DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV4DispWenDu2DecValue = -nw_Wendu;
			w_HighV4DispWenDu2DecValue = w_HighV4DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_HighV4DispWenDu2DecValue = w_HighV4WenDu2DecValue;

		nw_Wendu = (s16)(w_HighV4WenDu3DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV4DispWenDu3DecValue = -nw_Wendu;
			w_HighV4DispWenDu3DecValue = w_HighV4DispWenDu3DecValue + 10000; // 10000是负号
		}
		else
			w_HighV4DispWenDu3DecValue = w_HighV4WenDu3DecValue;

		nw_Wendu = (s16)(w_HighV4WenDu4DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV4DispWenDu4DecValue = -nw_Wendu;
			w_HighV4DispWenDu4DecValue = w_HighV4DispWenDu4DecValue + 10000; // 10000是负号
		}
		else
			w_HighV4DispWenDu4DecValue = w_HighV4WenDu4DecValue;

		nw_Wendu = (s16)(w_HighV4WenDu5DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV4DispWenDu5DecValue = -nw_Wendu;
			w_HighV4DispWenDu5DecValue = w_HighV4DispWenDu5DecValue + 10000; // 10000是负号
		}
		else
			w_HighV4DispWenDu5DecValue = w_HighV4WenDu5DecValue;

		nw_Wendu = (s16)(w_HighV4WenDu6DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV4DispWenDu6DecValue = -nw_Wendu;
			w_HighV4DispWenDu6DecValue = w_HighV4DispWenDu6DecValue + 10000; // 10000是负号
		}
		else
			w_HighV4DispWenDu6DecValue = w_HighV4WenDu6DecValue;
		// 以上温度值变换

		// 电机5 温度值变换
		nw_Wendu = (s16)(w_HighV5WenDu1DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV5DispWenDu1DecValue = -nw_Wendu;
			w_HighV5DispWenDu1DecValue = w_HighV5DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_HighV5DispWenDu1DecValue = w_HighV5WenDu1DecValue;

		nw_Wendu = (s16)(w_HighV5WenDu2DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV5DispWenDu2DecValue = -nw_Wendu;
			w_HighV5DispWenDu2DecValue = w_HighV5DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_HighV5DispWenDu2DecValue = w_HighV5WenDu2DecValue;

		nw_Wendu = (s16)(w_HighV5WenDu3DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV5DispWenDu3DecValue = -nw_Wendu;
			w_HighV5DispWenDu3DecValue = w_HighV5DispWenDu3DecValue + 10000; // 10000是负号
		}
		else
			w_HighV5DispWenDu3DecValue = w_HighV5WenDu3DecValue;

		nw_Wendu = (s16)(w_HighV5WenDu4DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV5DispWenDu4DecValue = -nw_Wendu;
			w_HighV5DispWenDu4DecValue = w_HighV5DispWenDu4DecValue + 10000; // 10000是负号
		}
		else
			w_HighV5DispWenDu4DecValue = w_HighV5WenDu4DecValue;

		nw_Wendu = (s16)(w_HighV5WenDu5DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV5DispWenDu5DecValue = -nw_Wendu;
			w_HighV5DispWenDu5DecValue = w_HighV5DispWenDu5DecValue + 10000; // 10000是负号
		}
		else
			w_HighV5DispWenDu5DecValue = w_HighV5WenDu5DecValue;

		nw_Wendu = (s16)(w_HighV5WenDu6DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV5DispWenDu6DecValue = -nw_Wendu;
			w_HighV5DispWenDu6DecValue = w_HighV5DispWenDu6DecValue + 10000; // 10000是负号
		}
		else
			w_HighV5DispWenDu6DecValue = w_HighV5WenDu6DecValue;
		// 以上温度值变换

		// 电机6 温度值变换
		nw_Wendu = (s16)(w_HighV6WenDu1DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV6DispWenDu1DecValue = -nw_Wendu;
			w_HighV6DispWenDu1DecValue = w_HighV6DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_HighV6DispWenDu1DecValue = w_HighV6WenDu1DecValue;

		nw_Wendu = (s16)(w_HighV6WenDu2DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV6DispWenDu2DecValue = -nw_Wendu;
			w_HighV6DispWenDu2DecValue = w_HighV6DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_HighV6DispWenDu2DecValue = w_HighV6WenDu2DecValue;

		nw_Wendu = (s16)(w_HighV6WenDu3DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV6DispWenDu3DecValue = -nw_Wendu;
			w_HighV6DispWenDu3DecValue = w_HighV6DispWenDu3DecValue + 10000; // 10000是负号
		}
		else
			w_HighV6DispWenDu3DecValue = w_HighV6WenDu3DecValue;

		nw_Wendu = (s16)(w_HighV6WenDu4DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV6DispWenDu4DecValue = -nw_Wendu;
			w_HighV6DispWenDu4DecValue = w_HighV6DispWenDu4DecValue + 10000; // 10000是负号
		}
		else
			w_HighV6DispWenDu4DecValue = w_HighV6WenDu4DecValue;

		nw_Wendu = (s16)(w_HighV6WenDu5DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV6DispWenDu5DecValue = -nw_Wendu;
			w_HighV6DispWenDu5DecValue = w_HighV6DispWenDu5DecValue + 10000; // 10000是负号
		}
		else
			w_HighV6DispWenDu5DecValue = w_HighV6WenDu5DecValue;

		nw_Wendu = (s16)(w_HighV6WenDu6DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV6DispWenDu6DecValue = -nw_Wendu;
			w_HighV6DispWenDu6DecValue = w_HighV6DispWenDu6DecValue + 10000; // 10000是负号
		}
		else
			w_HighV6DispWenDu6DecValue = w_HighV6WenDu6DecValue;
		// 以上温度值变换

		// 电机7 温度值变换
		nw_Wendu = (s16)(w_HighV7WenDu1DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV7DispWenDu1DecValue = -nw_Wendu;
			w_HighV7DispWenDu1DecValue = w_HighV7DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_HighV7DispWenDu1DecValue = w_HighV7WenDu1DecValue;

		nw_Wendu = (s16)(w_HighV7WenDu2DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV7DispWenDu2DecValue = -nw_Wendu;
			w_HighV7DispWenDu2DecValue = w_HighV7DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_HighV7DispWenDu2DecValue = w_HighV7WenDu2DecValue;

		nw_Wendu = (s16)(w_HighV7WenDu3DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV7DispWenDu3DecValue = -nw_Wendu;
			w_HighV7DispWenDu3DecValue = w_HighV7DispWenDu3DecValue + 10000; // 10000是负号
		}
		else
			w_HighV7DispWenDu3DecValue = w_HighV7WenDu3DecValue;

		nw_Wendu = (s16)(w_HighV7WenDu4DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV7DispWenDu4DecValue = -nw_Wendu;
			w_HighV7DispWenDu4DecValue = w_HighV7DispWenDu4DecValue + 10000; // 10000是负号
		}
		else
			w_HighV7DispWenDu4DecValue = w_HighV7WenDu4DecValue;

		nw_Wendu = (s16)(w_HighV7WenDu5DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV7DispWenDu5DecValue = -nw_Wendu;
			w_HighV7DispWenDu5DecValue = w_HighV7DispWenDu5DecValue + 10000; // 10000是负号
		}
		else
			w_HighV7DispWenDu5DecValue = w_HighV7WenDu5DecValue;

		nw_Wendu = (s16)(w_HighV7WenDu6DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV7DispWenDu6DecValue = -nw_Wendu;
			w_HighV7DispWenDu6DecValue = w_HighV7DispWenDu6DecValue + 10000; // 10000是负号
		}
		else
			w_HighV7DispWenDu6DecValue = w_HighV7WenDu6DecValue;
		// 以上温度值变换

		// 电机8 温度值变换
		nw_Wendu = (s16)(w_HighV8WenDu1DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV8DispWenDu1DecValue = -nw_Wendu;
			w_HighV8DispWenDu1DecValue = w_HighV8DispWenDu1DecValue + 10000; // 10000是负号
		}
		else
			w_HighV8DispWenDu1DecValue = w_HighV8WenDu1DecValue;

		nw_Wendu = (s16)(w_HighV8WenDu2DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV8DispWenDu2DecValue = -nw_Wendu;
			w_HighV8DispWenDu2DecValue = w_HighV8DispWenDu2DecValue + 10000; // 10000是负号
		}
		else
			w_HighV8DispWenDu2DecValue = w_HighV8WenDu2DecValue;

		nw_Wendu = (s16)(w_HighV8WenDu3DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV8DispWenDu3DecValue = -nw_Wendu;
			w_HighV8DispWenDu3DecValue = w_HighV8DispWenDu3DecValue + 10000; // 10000是负号
		}
		else
			w_HighV8DispWenDu3DecValue = w_HighV8WenDu3DecValue;

		nw_Wendu = (s16)(w_HighV8WenDu4DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV8DispWenDu4DecValue = -nw_Wendu;
			w_HighV8DispWenDu4DecValue = w_HighV8DispWenDu4DecValue + 10000; // 10000是负号
		}
		else
			w_HighV8DispWenDu4DecValue = w_HighV8WenDu4DecValue;

		nw_Wendu = (s16)(w_HighV8WenDu5DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV8DispWenDu5DecValue = -nw_Wendu;
			w_HighV8DispWenDu5DecValue = w_HighV8DispWenDu5DecValue + 10000; // 10000是负号
		}
		else
			w_HighV8DispWenDu5DecValue = w_HighV8WenDu5DecValue;

		nw_Wendu = (s16)(w_HighV8WenDu6DecValue);
		if (nw_Wendu < 0)
		{
			w_HighV8DispWenDu6DecValue = -nw_Wendu;
			w_HighV8DispWenDu6DecValue = w_HighV8DispWenDu6DecValue + 10000; // 10000是负号
		}
		else
			w_HighV8DispWenDu6DecValue = w_HighV8WenDu6DecValue;
		// 以上温度值变换

		// ZCL 2019.10.18 电力参数的变化，变化值进行显示
		// 电机1
		...
		// 电机2
		w_HighV2DispDianLi1 = (u16)(FtoU32(w_HighV2DianLi1, w_HighV2DianLi2) / 10); // 线电压1
		w_HighV2DispDianLi2 = (u16)(FtoU32(w_HighV2DianLi3, w_HighV2DianLi4) / 10); // 线电压2
		w_HighV2DispDianLi3 = (u16)(FtoU32(w_HighV2DianLi5, w_HighV2DianLi6) / 10); // 线电压3
		w_HighV2DispDianLi4 = (u16)(FtoU32(w_HighV2DianLi7, w_HighV2DianLi8));		// 相电流1
		w_HighV2DispDianLi5 = (u16)(FtoU32(w_HighV2DianLi9, w_HighV2DianLi10));		// 相电流2
		w_HighV2DispDianLi6 = (u16)(FtoU32(w_HighV2DianLi11, w_HighV2DianLi12));	// 相电流3
		w_HighV2DispDianLi7 = (u16)(FtoU32(w_HighV2DianLi13, w_HighV2DianLi14));	// 总有功功率
		w_HighV2DispDianLi8 = (u16)(FtoU32(w_HighV2DianLi15, w_HighV2DianLi16));	// 频率

		// 电机3
		w_HighV3DispDianLi1 = (u16)(FtoU32(w_HighV3DianLi1, w_HighV3DianLi2) / 10); // 线电压1
		w_HighV3DispDianLi2 = (u16)(FtoU32(w_HighV3DianLi3, w_HighV3DianLi4) / 10); // 线电压2
		w_HighV3DispDianLi3 = (u16)(FtoU32(w_HighV3DianLi5, w_HighV3DianLi6) / 10); // 线电压3
		w_HighV3DispDianLi4 = (u16)(FtoU32(w_HighV3DianLi7, w_HighV3DianLi8));		// 相电流1
		w_HighV3DispDianLi5 = (u16)(FtoU32(w_HighV3DianLi9, w_HighV3DianLi10));		// 相电流2
		w_HighV3DispDianLi6 = (u16)(FtoU32(w_HighV3DianLi11, w_HighV3DianLi12));	// 相电流3
		w_HighV3DispDianLi7 = (u16)(FtoU32(w_HighV3DianLi13, w_HighV3DianLi14));	// 总有功功率
		w_HighV3DispDianLi8 = (u16)(FtoU32(w_HighV3DianLi15, w_HighV3DianLi16));	// 频率

		// 电机4
		w_HighV4DispDianLi1 = (u16)(FtoU32(w_HighV4DianLi1, w_HighV4DianLi2) / 10); // 线电压1
		w_HighV4DispDianLi2 = (u16)(FtoU32(w_HighV4DianLi3, w_HighV4DianLi4) / 10); // 线电压2
		w_HighV4DispDianLi3 = (u16)(FtoU32(w_HighV4DianLi5, w_HighV4DianLi6) / 10); // 线电压3
		w_HighV4DispDianLi4 = (u16)(FtoU32(w_HighV4DianLi7, w_HighV4DianLi8));		// 相电流1
		w_HighV4DispDianLi5 = (u16)(FtoU32(w_HighV4DianLi9, w_HighV4DianLi10));		// 相电流2
		w_HighV4DispDianLi6 = (u16)(FtoU32(w_HighV4DianLi11, w_HighV4DianLi12));	// 相电流3
		w_HighV4DispDianLi7 = (u16)(FtoU32(w_HighV4DianLi13, w_HighV4DianLi14));	// 总有功功率
		w_HighV4DispDianLi8 = (u16)(FtoU32(w_HighV4DianLi15, w_HighV4DianLi16));	// 频率

		// 电机5
		w_HighV5DispDianLi1 = (u16)(FtoU32(w_HighV5DianLi1, w_HighV5DianLi2) / 10); // 线电压1
		w_HighV5DispDianLi2 = (u16)(FtoU32(w_HighV5DianLi3, w_HighV5DianLi4) / 10); // 线电压2
		w_HighV5DispDianLi3 = (u16)(FtoU32(w_HighV5DianLi5, w_HighV5DianLi6) / 10); // 线电压3
		w_HighV5DispDianLi4 = (u16)(FtoU32(w_HighV5DianLi7, w_HighV5DianLi8));		// 相电流1
		w_HighV5DispDianLi5 = (u16)(FtoU32(w_HighV5DianLi9, w_HighV5DianLi10));		// 相电流2
		w_HighV5DispDianLi6 = (u16)(FtoU32(w_HighV5DianLi11, w_HighV5DianLi12));	// 相电流3
		w_HighV5DispDianLi7 = (u16)(FtoU32(w_HighV5DianLi13, w_HighV5DianLi14));	// 总有功功率
		w_HighV5DispDianLi8 = (u16)(FtoU32(w_HighV5DianLi15, w_HighV5DianLi16));	// 频率

		// 电机6
		w_HighV6DispDianLi1 = (u16)(FtoU32(w_HighV6DianLi1, w_HighV6DianLi2) / 10); // 线电压1
		w_HighV6DispDianLi2 = (u16)(FtoU32(w_HighV6DianLi3, w_HighV6DianLi4) / 10); // 线电压2
		w_HighV6DispDianLi3 = (u16)(FtoU32(w_HighV6DianLi5, w_HighV6DianLi6) / 10); // 线电压3
		w_HighV6DispDianLi4 = (u16)(FtoU32(w_HighV6DianLi7, w_HighV6DianLi8));		// 相电流1
		w_HighV6DispDianLi5 = (u16)(FtoU32(w_HighV6DianLi9, w_HighV6DianLi10));		// 相电流2
		w_HighV6DispDianLi6 = (u16)(FtoU32(w_HighV6DianLi11, w_HighV6DianLi12));	// 相电流3
		w_HighV6DispDianLi7 = (u16)(FtoU32(w_HighV6DianLi13, w_HighV6DianLi14));	// 总有功功率
		w_HighV6DispDianLi8 = (u16)(FtoU32(w_HighV6DianLi15, w_HighV6DianLi16));	// 频率

		// 电机7
		w_HighV7DispDianLi1 = (u16)(FtoU32(w_HighV7DianLi1, w_HighV7DianLi2) / 10); // 线电压1
		w_HighV7DispDianLi2 = (u16)(FtoU32(w_HighV7DianLi3, w_HighV7DianLi4) / 10); // 线电压2
		w_HighV7DispDianLi3 = (u16)(FtoU32(w_HighV7DianLi5, w_HighV7DianLi6) / 10); // 线电压3
		w_HighV7DispDianLi4 = (u16)(FtoU32(w_HighV7DianLi7, w_HighV7DianLi8));		// 相电流1
		w_HighV7DispDianLi5 = (u16)(FtoU32(w_HighV7DianLi9, w_HighV7DianLi10));		// 相电流2
		w_HighV7DispDianLi6 = (u16)(FtoU32(w_HighV7DianLi11, w_HighV7DianLi12));	// 相电流3
		w_HighV7DispDianLi7 = (u16)(FtoU32(w_HighV7DianLi13, w_HighV7DianLi14));	// 总有功功率
		w_HighV7DispDianLi8 = (u16)(FtoU32(w_HighV7DianLi15, w_HighV7DianLi16));	// 频率

		// 电机8

		//	m=FtoU32(w_HighV8DianLi1,w_HighV8DianLi2);
		w_HighV8DispDianLi1 = (u16)(FtoU32(w_HighV8DianLi1, w_HighV8DianLi2) / 10); // 线电压1
		w_HighV8DispDianLi2 = (u16)(FtoU32(w_HighV8DianLi3, w_HighV8DianLi4) / 10); // 线电压2
		w_HighV8DispDianLi3 = (u16)(FtoU32(w_HighV8DianLi5, w_HighV8DianLi6) / 10); // 线电压3
		w_HighV8DispDianLi4 = (u16)(FtoU32(w_HighV8DianLi7, w_HighV8DianLi8));		// 相电流1
		w_HighV8DispDianLi5 = (u16)(FtoU32(w_HighV8DianLi9, w_HighV8DianLi10));		// 相电流2
		w_HighV8DispDianLi6 = (u16)(FtoU32(w_HighV8DianLi11, w_HighV8DianLi12));	// 相电流3
		w_HighV8DispDianLi7 = (u16)(FtoU32(w_HighV8DianLi13, w_HighV8DianLi14));	// 总有功功率
		w_HighV8DispDianLi8 = (u16)(FtoU32(w_HighV8DianLi15, w_HighV8DianLi16));	// 频率
	}
}
