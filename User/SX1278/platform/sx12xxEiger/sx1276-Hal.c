 ...
 */
#define RESET_IOPORT                                GPIOA					//ZCL 2018.11.9  2018.12.7
...
#define NSS_PIN                                     GPIO_Pin_0     //ZCL 2018.11.9  2018.12.7

/*!
 * SX1276 DIO pins  I/O definitions
 */
#define DIO0_IOPORT                                 GPIOD
#define DIO0_PIN                                    GPIO_Pin_2			//ZCL 2018.11.10  2018.12.7

#define DIO1_IOPORT                                 GPIOA
#define DIO1_PIN                                    GPIO_Pin_6			//ZCL 2018.11.10  2018.12.7
...
//ZCL 2018.11.13 修改成无用口
#define RXE_PORT       			GPIOD
#define RXE_PIN  				GPIO_Pin_10
#define RXE_CLOCK  				RCC_APB2Periph_GPIOD
...
#define TXE_PIN  				GPIO_Pin_11
#define TXE_CLOCK  				RCC_APB2Periph_GPIOD
...
{
	RXE_HIGH();		//ZCL 2018.11.13
	TXE_LOW();			//ZCL 2018.11.13
}

void Set_RF_Switch_TX(void)
{
	RXE_LOW();			//ZCL 2018.11.13
	TXE_HIGH();		//ZCL 2018.11.13
}
...
void SX1276WriteBuffer( uint8_t addr, uint8_t *buffer, uint8_t size )
{
    ...
    GPIO_WriteBit( NSS_IOPORT, NSS_PIN, Bit_RESET );
		SPI_LORA_CS_LOW();			//ZCL 2018.12.10
    ...
    //NSS = 1;
    GPIO_WriteBit( NSS_IOPORT, NSS_PIN, Bit_SET );
		SPI_FLASH_CS_HIGH();			//ZCL 2018.12.10
